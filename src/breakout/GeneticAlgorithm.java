...
public class GeneticAlgorithm {
    ...
    private BreakoutNeuralNetwork search() {
        ...
        for (int i = 0; i < NUM_GENERATIONS; i++) {
            ...
            if (Commons.SHOWGENERATION) System.out.println("Gen: " + i + " | Best Fitness: " + champion.getFitness());
            ...
            if (Commons.SHOWEVERY_50) if (i % 50 == 0) {
                new Breakout(champion, seed);
            }

            if (Commons.SHOWPOPULATION) printPopulation();
